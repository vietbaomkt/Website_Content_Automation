...
import { Shield, FileText, CreditCard, RefreshCw, Palette } from 'lucide-react';
import { useSEO } from '@/lib/useSEO';

const categories = {
  "thanh-toan": <><CreditCard size={14} className="inline mr-1.5 -mt-0.5" />Thanh toán</>,
  "hoan-tien": <><RefreshCw size={14} className="inline mr-1.5 -mt-0.5" />Hoàn tiền</>,
  "bao-mat": <><Shield size={14} className="inline mr-1.5 -mt-0.5" />Bảo mật</>,
  "dieu-khoan": <><FileText size={14} className="inline mr-1.5 -mt-0.5" />Điều khoản</>,
  "visual-identity": <><Palette size={14} className="inline mr-1.5 -mt-0.5" />Visual Identity</>,
};
