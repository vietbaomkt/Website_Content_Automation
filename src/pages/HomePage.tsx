  ...
  return (
    <>
      ...
      <HeroSection
        ...
        images={[
          { src: '/images/library/Library (1).png', alt: 'AI Content - Poster Film' },
          { src: '/images/library/Library (2).png', alt: 'AI Content - Portrait' },
          { src: '/images/library/Library (3).png', alt: 'AI Content - Quote Card' },
          { src: '/images/library/Library (4).png', alt: 'AI Content - Infographic' },
          { src: '/images/library/Library (5).png', alt: 'AI Content - Carousel' },
          { src: '/images/library/Library (6).png', alt: 'AI Content - Pain Mirror' },
          { src: '/images/library/Library (7).png', alt: 'AI Content - Storytelling' },
          { src: '/images/library/Library (8).png', alt: 'AI Content - Brand Visual 1' },
          { src: '/images/library/Library (9).png', alt: 'AI Content - Brand Visual 2' },
          { src: '/images/library/Library (10).png', alt: 'AI Content - Brand Visual 3' },
          { src: '/images/library/Library (11).png', alt: 'AI Content - Brand Visual 4' },
          { src: '/images/library/Library (12).png', alt: 'AI Content - Brand Visual 5' },
          { src: '/images/library/Library (13).png', alt: 'AI Content - Brand Visual 6' },
          { src: '/images/library/Library (14).png', alt: 'AI Content - Brand Visual 7' },
          { src: '/images/library/Library (15).png', alt: 'AI Content - Brand Visual 8' },
          { src: '/images/library/Library (16).png', alt: 'AI Content - Brand Visual 9' },
          { src: '/images/library/Library (17).png', alt: 'AI Content - Brand Visual 10' },
          { src: '/images/library/Library (18).png', alt: 'AI Content - Brand Visual 11' },
          { src: '/images/library/Library (19).png', alt: 'AI Content - Brand Visual 12' },
        ]}
      />
