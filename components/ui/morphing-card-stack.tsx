            ...
            {displayCards.map((card) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    "cursor-pointer rounded-xl border border-border bg-background/60 backdrop-blur-xl p-4",
                ...
                >
                  <div className="flex items-start gap-3">
                    {card.icon && (
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-white/10 text-foreground">
                        {card.icon}
                      </div>
                    )}
          ...
          {cards.map((_, index) => (
            <button
              ...
              className={cn(
                ...
                index === activeIndex ? "w-4 bg-blue-500" : "w-1.5 bg-muted-foreground/30 hover:bg-muted-foreground/50",
              )}
