  ...
  ({ title, subtitle, images, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'relative w-full min-h-[600px] flex flex-col items-center justify-center overflow-x-hidden text-white p-4',
          className
        )}
        {...props}
      >
        ...
        <div className="z-10 flex w-full flex-col items-center text-center space-y-8 md:space-y-12">
          ...
          <div className="relative w-full h-[350px] md:h-[450px] flex items-center justify-center">
              ...
              {images.map((image, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={cn(
                      'absolute w-64 h-80 md:w-80 md:h-[400px] transition-all duration-500 ease-in-out',
                  ...
                  >
                    <img
                      ...
                      width={320}
                      height={400}
                      className="object-cover w-full h-full rounded-3xl border-2 border-white/10 shadow-2xl"
                    />
                  </div>
                );
              })}
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute left-2 sm:left-8 top-1/2 -translate-y-1/2 rounded-full h-10 w-10 z-20 bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 hover:text-white"
              onClick={handlePrev}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute right-2 sm:right-8 top-1/2 -translate-y-1/2 rounded-full h-10 w-10 z-20 bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 hover:text-white"
              onClick={handleNext}
            >
